...
def get_dataloader(rank, world_size, batch_size=128):
    ...
    loader = torch.utils.data.DataLoader(
        dataset, batch_size=batch_size, sampler=sampler, shuffle=False, num_workers=4
    )
...
# ---------------------------
def train():
    # torchrun sets these env vars — read rank/world_size from them directly
    ...
    # DMC initializes the process group internally
    optimizer = DMC(
        model=model,
